...
The Tukey's test runs through all possible comparisons among treatment groups. The estimates that compare the control group to the other treatment groups are the same as the ones generated in the summary table. Once again, the large negative numbers indicate that, on average, the treatment groups' pea section lengths are smaller comapred to the control group. These contrasts also tell us that, on average, the glucose, fructose, and the combo's pea section lengths are similar. 
